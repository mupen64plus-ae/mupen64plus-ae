...
CombinerInputs Accurate::CombinerProgramBuilder::compileCombiner(const CombinerKey & _key, Combiner & _color, Combiner & _alpha, std::string & _strShader)
{
	gDPCombine combine;
...
graphics::CombinerProgram * Accurate::CombinerProgramBuilder::buildCombinerProgram(Combiner & _color,
																		Combiner & _alpha,
...
const ShaderPart * Accurate::CombinerProgramBuilder::getVertexShaderHeader() const
{
	return m_vertexHeader.get();
}

const ShaderPart * Accurate::CombinerProgramBuilder::getFragmentShaderHeader() const
{
	return m_fragmentHeader.get();
}

const ShaderPart * Accurate::CombinerProgramBuilder::getFragmentShaderEnd() const
{
...
Accurate::CombinerProgramBuilder::CombinerProgramBuilder(const opengl::GLInfo & _glinfo, opengl::CachedUseProgram * _useProgram)
...
Accurate::CombinerProgramBuilder::~CombinerProgramBuilder()
{
...
bool Accurate::CombinerProgramBuilder::isObsolete() const
{
