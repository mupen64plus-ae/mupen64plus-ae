...
import paulscode.android.mupen64plusae-mpn.game.GameSurface;
import paulscode.android.mupen64plusae-mpn.input.TouchController.OnStateChangedListener;
        ...
        AbstractProvider.OnInputListener
{
     ...
     * (non-Javadoc)
     * 
     * @see paulscode.android.mupen64plusae-mpn.input.provider.AbstractProvider.Listener#onInput(int,
     * float, int)
     */
    @Override
