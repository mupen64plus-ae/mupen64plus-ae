...
public class VisibleTouchMap extends TouchMap
{
     ...
     * (non-Javadoc)
     * 
     * @see paulscode.android.mupen64plusae-mpn.input.map.TouchMap#clear()
     */
    @Override
    public void clear()
    {
     ...
     * (non-Javadoc)
     * 
     * @see paulscode.android.mupen64plusae-mpn.input.map.TouchMap#resize(int, int)
     */
    @Override
     ...
     * 
     * @see
     * paulscode.android.mupen64plusae-mpn.input.map.TouchMap#loadAllAssets(paulscode.android.mupen64plusae-mpn
