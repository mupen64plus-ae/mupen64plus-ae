...
public class VisibleTouchMap extends TouchMap
{
     ...
     * (non-Javadoc)
     * 
     * @see emulator.android.mupen64plusae.input.map.TouchMap#clear()
     */
    @Override
    public void clear()
    {
     ...
     * (non-Javadoc)
     * 
     * @see emulator.android.mupen64plusae.input.map.TouchMap#resize(int, int)
     */
    @Override
     ...
     * 
     * @see
     * emulator.android.mupen64plusae.input.map.TouchMap#loadAllAssets(emulator.android.mupen64plusae
