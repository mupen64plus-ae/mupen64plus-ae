 ...
 * Authors: littleguy77
 */
package emulator.android.mupen64plusae.input;
...
import emulator.android.mupen64plusae.game.GameSurface;
import emulator.android.mupen64plusae.input.TouchController.OnStateChangedListener;
import emulator.android.mupen64plusae.input.map.InputMap;
import emulator.android.mupen64plusae.input.map.PlayerMap;
        ...
        AbstractProvider.OnInputListener
{
     ...
     * (non-Javadoc)
     * 
     * @see emulator.android.mupen64plusae.input.provider.AbstractProvider.Listener#onInput(int,
     * float, int)
     */
    @Override
