...
void Java_paulscode_android_mupen64plus_GameActivityCommon_pauseEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_PAUSE, 0, NULL );
}

void Java_paulscode_android_mupen64plus_GameActivityCommon_resumeEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_RESUME, 0, NULL );
}

void Java_paulscode_android_mupen64plus_GameActivityCommon_stopEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STOP, 0, NULL );
}

void Java_paulscode_android_mupen64plus_GameActivityCommon_stateSetSlotEmulator(
                                    JNIEnv* env, jclass cls, jint slotID )
{
    (*CoreDoCommand) ( M64CMD_STATE_SET_SLOT, (int) slotID, NULL );
}
void Java_paulscode_android_mupen64plus_GameActivityCommon_stateSaveEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STATE_SAVE, 1, NULL );
}
void Java_paulscode_android_mupen64plus_GameActivityCommon_stateLoadEmulator(
                                    JNIEnv* env, jclass cls)
{
    (*CoreDoCommand) ( M64CMD_STATE_LOAD, 0, NULL );
}

void Java_paulscode_android_mupen64plus_GameActivityCommon_fileSaveEmulator(
...
void Java_paulscode_android_mupen64plus_GameActivityCommon_fileLoadEmulator(
                                    JNIEnv* env, jclass cls, jstring filename )
{
    const char *nativeString = (*env)->GetStringUTFChars( env, filename, 0 );
...
jint Java_paulscode_android_mupen64plus_GameActivityCommon_stateEmulator(
                                    JNIEnv* env, jclass cls)
{
    int state = 0;
...
jstring Java_paulscode_android_mupen64plus_GameActivityCommon_nativeGetHeaderName(
...
jstring Java_paulscode_android_mupen64plus_GameActivityCommon_nativeGetHeaderCRC(
                                       JNIEnv* env, jclass cls, jstring jFilename )
{
    const char *nativeS = (*env)->GetStringUTFChars( env, jFilename, 0 );
    strcpy( strBuff, nativeS );
