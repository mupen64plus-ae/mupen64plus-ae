...
PFNGLBLENDEQUATIONPROC g_glBlendEquation;
PFNGLBLENDEQUATIONSEPARATEPROC g_glBlendEquationSeparate;
PFNGLBLENDFUNCSEPARATEPROC g_glBlendFuncSeparate;
PFNGLFRONTFACEPROC g_glFrontFace;
PFNGLUNIFORMMATRIX4FVPROC g_glUniformMatrix4fv;
PFNGLUNIFORM3FPROC g_glUniform3f;
...
namespace  EGLLoader {
	...
	void loadEGLFunctions() {
		...
		GL_GET_PROC_ADR(PFNGLBLENDEQUATIONPROC, glBlendEquation);
		GL_GET_PROC_ADR(PFNGLBLENDEQUATIONSEPARATEPROC, glBlendEquationSeparate);
		GL_GET_PROC_ADR(PFNGLBLENDFUNCSEPARATEPROC, glBlendFuncSeparate);
		GL_GET_PROC_ADR(PFNGLFRONTFACEPROC, glFrontFace);
