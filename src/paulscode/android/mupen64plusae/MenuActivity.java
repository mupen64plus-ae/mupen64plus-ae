...
public class MenuActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener
{
    ...
    protected void onCreate( Bundle savedInstanceState )
    {
        ...
        Globals.settings = new Settings(getPreferenceScreen().getSharedPreferences());
    }
      
    @Override
    public boolean onKeyDown( int keyCode, KeyEvent event )
    {
        // Force user to exit app from main menu
...
//            return true;
    ...
    protected void onResume()
    {
        ...
        super.onResume();
        Globals.settings.sharedPreferences.registerOnSharedPreferenceChangeListener( this );
    }
    ...
    protected void onPause()
    {
        // Inspired by http://stackoverflow.com/a/531927/254218
        super.onPause();
        Globals.settings.sharedPreferences.unregisterOnSharedPreferenceChangeListener( this );
    }
    
    public void onSharedPreferenceChanged( SharedPreferences sharedPreferences, String key )
    {
        // Update the global convenience class
        Globals.settings = new Settings( sharedPreferences );
...
//        final String[] languageValues = { "00",
//                // "ar",
//                // "zh",
//                "hr", "nl", "en", "fr", "de",
//                // "it",
