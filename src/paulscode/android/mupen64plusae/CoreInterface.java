...
public class CoreInterface
{
    ...
    private static void syncConfigFiles( UserPrefs user, AppData appData )
    {
        ...
        mupen64plus_cfg.put( "Core", "ScreenshotPath", '"' + user.screenshotDir + '"' );                                    // Path to directory where screenshots are saved. If this is blank, the default value of ${UserConfigPath}/screenshot will be used
